    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=200, verbose_name='Tên BĐS')),
                ('price', models.DecimalField(verbose_name='Giá chào', decimal_places=2, max_digits=4,)),
                ('sale_price', models.DecimalField(blank=True, null=True, verbose_name='Giá hạ chào', decimal_places=2, max_digits=4,)),
                ...
                ('street', models.CharField(help_text='Tên đường, phố', max_length=125, verbose_name='Phố', blank=True, null=True)),
                ('address', models.CharField(help_text='Số nhà/hẻm/ngách/ngõ',  max_length=255,  verbose_name='Địa chỉ đầy đủ')),
                ...
                ('location', location_field.models.spatial.LocationField(
                 default=django.contrib.gis.geos.point.Point(105.8401439, 21.0334474), null=True, srid=4326)),
