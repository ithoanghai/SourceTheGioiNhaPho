...
from FunctionModule.accounts.adapter import get_adapter as get_account_adapter
...
from FunctionModule.social_account import app_settings
...
class DefaultSocialAccountAdapter(object):
    ...
    def validate_disconnect(self, account, accounts):
        ...
        if len(accounts) == 1:
            ...
            if app_settings.EMAIL_VERIFICATION == account_settings.EmailVerificationMethod.MANDATORY:
                if (
