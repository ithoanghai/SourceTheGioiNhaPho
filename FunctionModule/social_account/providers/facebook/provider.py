...
from FunctionModule.social_account.app_settings import QUERY_EMAIL
from FunctionModule.social_account.providers.base import (
    AuthAction,
    AuthProcess,
    ProviderAccount,
)
from FunctionModule.social_account.providers.oauth2.provider import OAuth2Provider
...
class FacebookProvider(OAuth2Provider):
    ...
    def media_js(self, request):
        ...
        from FunctionModule.social_account.models import SocialApp
