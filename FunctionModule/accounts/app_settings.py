class AppSettings(object):
    ...
    @property
    def ADAPTER(self):
        return self._setting("ADAPTER", "FunctionModule.accounts.adapter.DefaultAccountAdapter")
    ...
    @property
    def ADAPTER_SOCIAL(self):
        return self._setting(
            "ADAPTER_SOCIAL",
            "FunctionModule.accounts.adapter" ".DefaultSocialAccountAdapter",
        )
