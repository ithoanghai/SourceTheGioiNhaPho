!function (t) {
    ...
    "+66z": function (t, e) {
        ...
        var r, i, o, a, s, u, c = n("u2KI"), l = n.n(c), f = n("bOdI"), d = n.n(f), p = "du-an",
            ...
            U = (s = {}, d()(s, T.APARTMENT, "Căn hộ"), d()(s, T.SERVICE_APARTMENT, "Căn hộ dịch vụ"), d()(s, T.PENT_HOUSE, "Nhà áp mái (Pent-house)"), d()(s, T.VILLA, "Biệt thự"), d()(s, T.LOFT_HOUSE, "Nhà gác xép/Cấp 4"), d()(s, T.OFFICE_TEL, "Văn phòng khách sạn (Office-tel)"), d()(s, T.CONDO_TEL, "Căn hộ khách sạn (Condo-tel)"), d()(s, T.TOWN_HOUSE, "Nhà phố"), d()(s, T.SHOP_HOUSE, "shop_house"), d()(s, T.VILLA_REST, "Biệt thự nghỉ dưỡng"), d()(s, T.PLOT, "Đất nền"), d()(s, T.OFFICE, "Văn phòng"), d()(s, T.BUILDING_BUSINESS, "Tòa nhà KD"), d()(s, T.LAND_BUSINESS, "Mặt bằng KD"), d()(s, T.WAREHOUSE_WORKSHOP, "Nhà xưởng kho bãi"), d()(s, T.INDUSTRIAL_LAND, "Đất công nghiệp"), d()(s, T.OTHER, "Khác"), s),
