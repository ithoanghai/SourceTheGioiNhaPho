!function (t) {
    ...
    "+66z": function (t, e) {
            ...
            u = n("JDN0"), l = n.n(u), f = n("BJzf"), h = n.n(f), p = n("m0Xf"), m = function () {
                function t(e, n, r, o) {
                    i()(this, t), this.hotline = p.b, this.dismissFunc = o, this.onSubmitFn = [], this.suggestItems = ["Quận Hoàn Kiếm", "Quận Ba Đình", "Quận Đống Đa", "Quận Bình Thạnh", "Thảo Điền", "Thủ Thiêm", "An Phú An Khánh", "Vinhomes Central Park", "Phú Mỹ Hưng", "Quận 9"], this.propertyTypes = [{
                        ...
                        value: "dat-nen",
                        text: "Đất Nền"
                    }, {value: "shop_house", text: "Cửa hàng"}, {value: "Văn phòng khách sạn (Office-tel)", text: "Văn phòng khách sạn (Office-tel)"}, {
                        value: "other",
                        text: "Khác"
                ...
                return a()(t, [{
                    key: "init", value: function (t) {
                        if (t) {
                            (l()(t) ? Object(s.b)(t) : t).prepend(this.form)
                        }
                    }
                }, {
                    key: "initForm", value: function () {
                        var t = this;
                        this.form = Object(s.b)(Object(c.d)(h.a, this));
                        var e = this;
                        this.form.find("select[data-items]").each(function (t, n) {
                            var r = Object(s.b)(n), i = e[r.attr("data-items")] || [];
                    ...
                    key: "submit", value: function () {
                        if (d.a.validate(this.form)) {
                            var t = d.a.serialize(this.form);
                            t.is_receive_price = !!t.is_receive_price, t.is_get_analysis = !!t.is_get_analysis, d.a.submit(this.form, "/mapi/form/v2/buying_renting", t, this.dismissFunc), this.onSubmitFn.forEach(function (t) {
                    ...
                    key: "reset", value: function (t, e) {
                        d.a.reset(this.form), this.serviceType = t, this.reverId = e
                    }
                }, {
            ...
            t.datetimepicker = {
                ...
                return a = function (e) {
                    var o, a, c, d, N, P, E = t('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
                        ...
                        F = t('<div class="xdsoft_datepicker active"></div>'),
                        ...
                        n.mask && e.off("keydown.xdsoft"), !0 === n.mask && ("undefined" != typeof moment ? n.mask = n.format.replace(/Y{4}/g, "9999").replace(/Y{2}/g, "99").replace(/M{2}/g, "19").replace(/D{2}/g, "39").replace(/H{2}/g, "29").replace(/m{2}/g, "59").replace(/s{2}/g, "59") : n.mask = n.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === t.type(n.mask) && (r(n.mask, e.val()) || (e.val(n.mask.replace(/[0-9]/g, "_")), i(e[0], 0)), e.on("paste.xdsoft", function (o) {
                            ...
                            if (c >= u && c <= l || c >= f && c <= h || c === y || c === m) {
                                for (a = c === y || c === m ? "_" : String.fromCharCode(f <= c && c <= h ? c - u : c), c === y && d && !N && (d -= 1); ;) {
                                    var P = n.mask.substr(d, 1), E = d < n.mask.length, W = d > 0;
                                    if (!(/[^0-9_]/.test(P) && E && W)) break;
                                    d += c !== y || N ? 1 : -1
                                }
                                if (N) {
                                    var F = Y - d, j = n.mask.replace(/[0-9]/g, "_"), I = j.substr(d, F).substr(1);
                                    s = s.substr(0, d) + (a + I) + s.substr(d + F)
                    ...
                    j.find(".xdsoft_select").xdsoftScroller(Y).on("touchstart mousedown.xdsoft", function (t) {
                        ...
                        H.xdsoftScroller(Y)
                    }), E.append(F).append(R), !0 !== Y.withoutCopyright && E.append(W), F.append(j).append(I).append(U), t(Y.parentID).append(E), N = new function () {
                        var e = this;
                        e.now = function (t) {
                            var n, r, i = new Date;
                        ...
                        if (e = (c = E.data("input")).offset(), n = c[0], u = "top", r = e.top + n.offsetHeight - 1, i = e.left, o = "absolute", d = t(Y.contentWindow).width(), f = t(Y.contentWindow).height(), h = t(Y.contentWindow).scrollTop(), Y.ownerDocument.documentElement.clientWidth - e.left < F.parent().outerWidth(!0)) {
        ...
        var r, i, o, a, s = n("O4g8"), c = n("7KvD"), d = n("+ZMJ"), u = n("RY/4"), l = n("kM2E"), f = n("EqjI"),
            ...
            D = S && S.versions, T = D && D.v8 || "", M = c.Promise, O = "process" == u(S), A = function () {
            }, C = i = x.f, Y = !!function () {
                try {
                ...
                if (!t._n) {
                    ...
                    y(function () {
                        for (var r = t._v, i = 1 == t._s, o = 0, a = function (e) {
                            ...
                            try {
                                s ? (i || (2 == t._h && F(t), t._h = 1), !0 === s ? n = r : (u && u.enter(), n = s(r), u && (u.exit(), a = !0)), n === e.promise ? d(w("Promise-chain cycle")) : (o = N(n)) ? o.call(n, c, d) : c(n)) : d(r)
                            } catch (t) {
                                u && !a && u.exit(), d(t)
                            }
                        }; n.length > o;) a(n[o++]);
            ...
            r = function () {
                ...
                function Ae(t) {
                    ...
                    if (!t._d) {
                        for (r = function (t) {
                            ...
                            var e, n, r, i, o, a, s, c, d;
                            null != (e = t._w).GG || null != e.W || null != e.E ? (o = 1, a = 4, n = Oe(e.GG, t._a[wt], Bt(Pe(), 1, 4).year), r = Oe(e.W, 1), ((i = Oe(e.E, 1)) < 1 || i > 7) && (c = !0)) : (o = t._locale._week.dow, a = t._locale._week.doy, d = Bt(Pe(), o, a), n = Oe(e.gg, t._a[wt], d.year), r = Oe(e.w, d.week), null != e.d ? ((i = e.d) < 0 || i > 6) && (c = !0) : null != e.e ? (i = e.e + o, (e.e < 0 || e.e > 6) && (c = !0)) : i = o);
                ...
                function Ce(t) {
                    if (t._f !== o.ISO_8601) if (t._f !== o.RFC_2822) {
                        ...
                        for (r = R(t._f, t._locale).match(P) || [], e = 0; e < r.length; e++) i = r[e], (n = (c.match(gt(i, t)) || [])[0]) && ((a = c.substr(0, c.indexOf(n))).length > 0 && g(t).unusedInput.push(a), c = c.slice(c.indexOf(n) + n.length), u += n.length), F[i] ? (n ? g(t).empty = !1 : g(t).unusedTokens.push(i), _t(i, n, t)) : t._strict && !n && g(t).unusedTokens.push(i);
                ...
                var _n = Z("Minutes", !1);
                j("s", ["ss", 2], 0, "second"), L("second", "s"), V("second", 15), mt("s", it), mt("ss", it, tt), xt(["s", "ss"], Ot);
                ...
                Tn.add = tn, Tn.calendar = function (t, e) {
                    ...
                    return v(this)
                }, Tn.lang = sn, Tn.locale = an, Tn.localeData = cn, Tn.max = We, Tn.min = Ee, Tn.parsingFlags = function () {
                    return p({}, g(this))
                }, Tn.set = function (t, e) {
                    if ("object" == typeof t) {
                        var n, r = function (t) {
                ...
                On.calendar = function (t, e, n) {
                    ...
                    var e, n;
                    for (n in t) c(t, n) && (A(e = t[n]) ? this[n] = e : this["_" + n] = e);
                    ...
                    return this._monthsParseExact ? (c(this, "_monthsRegex") || Ht.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex) : (c(this, "_monthsShortRegex") || (this._monthsShortRegex = Ft), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex)
                }, On.week = function (t) {
                ...
                return ar.isValid = function () {
                    ...
                    if ("month" === (t = U(t)) || "quarter" === t || "year" === t) switch (e = this._days + r / 864e5, n = this._months + Wn(e), t) {
                        ...
                        case"year":
                            return n / 12
                    } else switch (e = this._days + Math.round(Fn(this._months)), t) {
                        case"week":
                            return e / 7 + r / 6048e5;
                        case"day":
                            return e + r / 864e5;
                    ...
                    return o >= 0 && a >= 0 && s >= 0 || o <= 0 && a <= 0 && s <= 0 || (o += 864e5 * En(Fn(s) + a), a = 0, s = 0), c.milliseconds = o % 1e3, t = J(o / 1e3), c.seconds = t % 60, e = J(t / 60), c.minutes = e % 60, n = J(e / 60), c.hours = n % 24, s += i = J(Wn(a += J(n / 24))), a -= En(Fn(i)), r = J(s / 12), s %= 12, c.days = a, c.months = s, c.years = r, this
                }, ar.clone = function () {
                    return Ze(this)
                }, ar.get = function (t) {
        ...
        var r = n("7KvD"), i = n("D2L2"), o = n("+E39"), a = n("kM2E"), s = n("880/"), c = n("06OY").KEY, d = n("S82l"),
            ...
            V = !z || !z.prototype || !z.prototype.findChild, B = o && d(function () {
                ...
                return t === U && Z(L, e, n), y(t), e = k(e, !0), y(n), i(H, e) ? (n.enumerable ? (i(t, F) && t[F][e] && (t[F][e] = !1), n = S(n, {enumerable: w(0, !1)})) : (i(t, F) || Y(t, F, w(1, {})), t[F][e] = !0), B(t, e, n)) : Y(t, e, n)
            }, q = function (t, e) {
                y(t);
                ...
                return !(this === U && i(H, t) && !i(L, t)) && (!(e || !i(this, t) || !i(H, t) || i(this, F) && this[F][t]) || e)
            }, X = function (t, e) {
                ...
                for (var e, n = N(_(t)), r = [], o = 0; n.length > o;) i(H, e = n[o++]) || e == F || e == c || r.push(e);
                return r
            }, tt = function (t) {
        ...
        G || (s((P = function () {
            ...
            var t = f(arguments.length > 0 ? arguments[0] : void 0), e = function (n) {
                this === U && e.call(L, n), i(this, F) && i(this[F], t) && (this[F][t] = !1), B(this, t, w(1, n))
            };
        ...
        var r = n("eBGp"), i = n("Zrlr"), o = n.n(i), a = n("wxAW"), s = n.n(a), c = n("88TU"), d = new (function () {
        ...
        }()), u = n("+D6Y"), l = n("SrM6"), f = n("fB4n"), h = '[data-action="contact-agent"]', p = new (function () {
            function t() {
                var e = this;
                o()(this, t), this.btnShowForm = Object(c.b)(h), this.goog_snippet_vars = function () {
                    var t = window;
            ...
            return s()(t, [{
                key: "init", value: function () {
                    var t = this;
                    this.contactForm = new u.a("#contact-now-form-body", "", null, this.hideForm.bind(this)), this.contactForm.onSubmit(function () {
                        t.goog_report_conversion && t.goog_report_conversion()
                ...
                key: "hideForm", value: function () {
                    l.a.hide("contact-now-form")
                }
            }, {
                key: "showForm", value: function (t) {
                    t.preventDefault(), this.contactForm.reset(), l.a.show("contact-now-form", {
                        body: ".popup-520",
                        close: ".close-popup-btn"
                    }), f.a.trackClickContact("other")
                }
            }]), t
        }());
        Object(r.g)(d, p)
            ...
            j = {date: "DD/MM/YYYY", datepicker: "d/m/Y"}, I = {
                ...
                init: function (t) {
                    if (t) {
                        ...
                        t.find("[" + W + "=" + F.date + "]").datetimepicker({
                            timepicker: !1,
                            format: j.datepicker,
                            minDate: 0
                        }), t.find("[" + W + "=" + F.number + "]").inputnumber(), t.find(".form-dropdown select").dropdown({
                    ...
                    if (!t) return null;
                    var e = t.find("[" + W + '="' + F.number + '"]'), n = t.find("[" + W + '="' + F.date + '"]'), r = {};
                    ...
                    if (t) {
                        ...
                        for (var r = t.find("input[type=text], input[type=number], input[type=email]").not("[" + W + '="' + F.date + '"]'), i = 0; i < r.length; i++) {
                            var o = E(r[i]);
        ...
        t.exports = function (t, e, n, p, m, g, v) {
            ...
            if (A && (b = u(A.call(new t))) !== Object.prototype && b.next && (d(b, k, !0), r || "function" == typeof b[l] || a(b, l, h)), w && T && "values" !== T.name && (S = !0, M = function () {
                return T.call(this)
