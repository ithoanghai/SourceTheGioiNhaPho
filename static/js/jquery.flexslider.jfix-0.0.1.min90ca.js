!function (e) {
    ...
    e.flexslider = function (a, n) {
        var i = e(a);
        i.vars = e.extend({}, e.flexslider.defaults, n), i.jfix = n.jfix;
        var r, s = i.vars.namespace, o = window.navigator && window.navigator.msPointerEnabled && window.MSGesture,
        ...
        e.data(a, "flexslider", i), g = {
            init: function () {
                ...
                setup: function () {
                    i.asNav = !0, i.animatingTo = Math.floor(i.currentSlide / i.move), i.currentItem = i.currentSlide, i.slides.removeClass(s + "active-slide").eq(i.currentItem).addClass(s + "active-slide"), o ? (a._slider = i, i.slides.each(function () {
                        ...
                        t.preventDefault();
                        var a = e(this), n = a.index(), r = a.offset().left - e(i).scrollLeft();
                        0 >= r && a.hasClass(s + "active-slide") ? i.flexAnimate(i.getTarget("prev"), !0) : e(i.vars.asNavFor).data("flexslider").animating || a.hasClass(s + "active-slide") || (i.direction = i.currentItem < n ? "next" : "prev", i.flexAnimate(n, i.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            }, controlNav: {
                setup: function () {
                    ...
                    var t, a, n = "thumbnails" === i.vars.controlNav ? "control-thumbs" : "control-paging", r = 1;
                    if (i.controlNavScaffold = e('<ol class="' + s + "control-nav " + s + n + '"></ol>'), i.pagingCount > 1) for (var o = 0; o < i.pagingCount; o++) {
                ...
                function t(e) {
                    ...
                    if (t) {
                        ...
                        return w += u ? i : n, d = w, y = u ? Math.abs(w) < Math.abs(-n) : Math.abs(w) < Math.abs(-i), e.detail === e.MSGESTURE_FLAG_INERTIA ? void setImmediate(function () {
                            a._gesture.stop()
                        }) : void ((!y || Number(new Date) - f > 500) && (e.preventDefault(), !m && t.transitions && (t.vars.animationLoop || (d = w / (0 === t.currentSlide && 0 > w || t.currentSlide === t.last && w > 0 ? Math.abs(w) / c + 2 : 1)), t.setProps(l + d, "setTouch"))))
                    }
                }
                ...
                function n(e) {
                    ...
                    if (t) {
                        ...
                        r = null, s = null, d = null, l = null, w = 0
                    }
                }

                var r, s, l, c, d, f, g, h, S, y = !1, x = 0, b = 0, w = 0;
                o ? (a.style.msTouchAction = "none", a._gesture = new MSGesture, a._gesture.target = a, a.addEventListener("MSPointerDown", e, !1), a._slider = i, a.addEventListener("MSGestureChange", t, !1), a.addEventListener("MSGestureEnd", n, !1)) : (g = function (e) {
                    i.animating ? e.preventDefault() : (window.navigator.msPointerEnabled || 1 === e.touches.length) && (i.pause(), c = u ? i.h : i.w, f = Number(new Date), x = e.touches[0].pageX, b = e.touches[0].pageY, l = p && v && i.animatingTo === i.last ? 0 : p && v ? i.limit - (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo : p && i.currentSlide === i.last ? i.limit : p ? (i.itemW + i.vars.itemMargin) * i.move * i.currentSlide : v ? (i.last - i.currentSlide + i.cloneOffset) * c : (i.currentSlide + i.cloneOffset) * c, r = u ? b : x, s = u ? x : b, a.addEventListener("touchmove", h, !1), a.addEventListener("touchend", S, !1))
                }, h = function (e) {
                    x = e.touches[0].pageX, b = e.touches[0].pageY, d = u ? r - b : r - x, y = u ? Math.abs(d) < Math.abs(x - s) : Math.abs(d) < Math.abs(b - s);
                    var t = 500;
                    ...
                    a.removeEventListener("touchend", S, !1), r = null, s = null, d = null, l = null
                ...
                if (!u || m) {
                    ...
                    e ? t.animate({height: i.slides.eq(i.animatingTo).innerHeight()}, e).css("overflow", "visible") : t.innerHeight(i.slides.eq(i.animatingTo).innerHeight())
                }
            }, sync: function (t) {
            ...
            if (i.vars.animationLoop || t === i.currentSlide || (i.direction = t > i.currentSlide ? "next" : "prev"), f && 1 === i.pagingCount && (i.direction = i.currentItem < t ? "next" : "prev"), !i.animating && (i.canAdvance(t, o) || n) && i.is(":visible")) {
                ...
                if (i.animating = !0, i.animatingTo = t, a && i.pause(), i.vars.before(i), i.syncExists && !o && g.sync("animate"), i.vars.controlNav && g.controlNav.active(), p || i.slides.removeClass(s + "active-slide").eq(t).addClass(s + "active-slide"), i.atEnd = 0 === t || t === i.last, i.vars.directionNav && g.directionNav.update(), t === i.last && (i.vars.end(i), i.vars.animationLoop || i.pause()), m) l ? (i.slides.eq(i.currentSlide).css({
                    ...
                    zIndex: 1,
                    display: "none"
                }).animate({opacity: 0}, i.vars.animationSpeed, i.vars.easing), i.slides.eq(t).css({
                    zIndex: 2,
                    display: "block"
                }).animate({opacity: 1}, i.vars.animationSpeed, i.vars.easing, i.wrapup)); else {
        ...
        }, i.setProps = function (t, a, n) {
            var r = function () {
                var n = t ? t : (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo, r = function () {
                    if (p) {
                        if (i.jfix) {
                            var r = 0, s = i.find("ul li");
                            if (!t) return 0;
                            for (var o = 0; o < i.animatingTo; o++) r += e(s[o]).width() + i.vars.itemMargin;
                            var l = i.width();
                            return r + l > i.limit && (r = i.limit - l - i.vars.itemMargin), r
                        }
                        return "setTouch" === a ? t : v && i.animatingTo === i.last ? 0 : v ? i.limit - (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo : i.animatingTo === i.last ? i.limit : n
                    }
                    switch (a) {
                        case"setTotal":
                            return v ? (i.count - 1 - i.currentSlide + i.cloneOffset) * t : (i.currentSlide + i.cloneOffset) * t;
                        case"setTouch":
                            return v ? t : t;
                        case"jumpEnd":
                            return v ? t : i.count * t;
                        case"jumpStart":
                            return v ? i.count * t : t;
                        default:
                            return t
                    }
                }();
            ...
            if (m) i.slides.css({
                ...
                display: "none",
                zIndex: 1
            }).eq(i.currentSlide).css({zIndex: 2, display: "block"}).css({opacity: 1}) : i.slides.css({
                opacity: 0,
                display: "none",
                zIndex: 1
            }).eq(i.currentSlide).css({
                zIndex: 2,
                display: "block"
            }).animate({opacity: 1}, i.vars.animationSpeed, i.vars.easing)), i.vars.smoothHeight && g.smoothHeight(); else {
                var a, n;
            ...
            var t = i.slides.first(), a = i.vars.itemMargin, n = i.vars.minItems, r = i.vars.maxItems;
            if (i.w = void 0 === i.viewport ? i.width() : i.viewport.width(), i.h = t.height(), i.boxPadding = t.outerWidth() - t.width(), p) {
                if (i.itemT = i.vars.itemWidth + a, i.itemM = a, i.minW = n ? n * i.itemT : i.w, i.maxW = r ? r * i.itemT - a : i.w, i.itemW = i.minW > i.w ? (i.w - a * (n - 1)) / n : i.maxW < i.w ? (i.w - a * (r - 1)) / r : i.vars.itemWidth > i.w ? i.w : i.vars.itemWidth, i.visible = Math.floor(i.w / i.itemW), i.move = i.vars.move > 0 && i.vars.move < i.visible ? i.vars.move : i.visible, i.pagingCount = Math.ceil((i.count - i.visible) / i.move + 1), i.last = i.pagingCount - 1, i.jfix) {
                    i.limit = 0;
                    for (var s = i.find("ul li"), o = 0; o < s.length; o++) i.limit += e(s[o]).width() + i.vars.itemMargin
                } else i.limit = 1 === i.pagingCount ? 0 : i.vars.itemWidth > i.w ? i.itemW * (i.count - 1) + a * (i.count - 1) : (i.itemW + a) * i.count - i.w - a;
                i.vars.itemWidth > i.w ? i.itemW * (i.count - 1) + a * (i.count - 1) : (i.itemW + a) * i.count - i.w - a
            } else i.itemW = i.w, i.itemM = a, i.pagingCount = i.count, i.last = i.count - 1;
            i.computedW = i.itemW - i.boxPadding, i.computedM = i.itemM
