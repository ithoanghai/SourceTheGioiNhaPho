...
function initMap() {
    ...
    var t = new google.maps.Marker({
        ...
        o = new google.maps.InfoWindow({content: '<div class="info-window-content"></div>'});
...
var Navbar = function () {
    ...
    if ($(".input-slider-container")[0] && $(".input-slider-container").each(function () {
        var e = $(this).find(".input-slider"), a = e.attr("id"), t = e.data("range-value-min"),
            o = e.data("range-value-max"), n = $(this).find(".range-slider-value"), r = n.attr("id"),
            l = n.data("range-value-low"), i = document.getElementById(a), s = document.getElementById(r);
        noUiSlider.create(i, {
            start: [parseInt(l)],
            connect: [!0, !1],
        ...
        var e = document.getElementById("input-slider-range"),
            ...
            t = document.getElementById("input-slider-range-value-high"), o = [a, t];
        noUiSlider.create(e, {
    ...
    var e, a = $('[data-toggle="chart"]'), t = "light", o = {base: "Open Sans"}, n = {
        gray: {
            100: "#f6f9fc",
            200: "#e9ecef",
            300: "#dee2e6",
                ...
                tooltips: {
                    enabled: !1, mode: "index", intersect: !1, custom: function (o) {
                        ...
                        if (e.length || (e = $('<div id="chart-tooltip" class="popover bs-popover-top" role="tooltip"></div>'), $("body").append(e)), 0 !== o.opacity) {
                            if (o.body) {
                                var a = o.title || [], n = o.body.map(function (e) {
                                    return e.lines
                                }), r = "";
                            ...
                            var t = $(this._chart.canvas), l = (t.outerWidth(), t.outerHeight(), t.offset().top),
                                i = t.offset().left, s = e.outerWidth(), d = e.outerHeight(), c = l + o.caretY - d - 16,
                                p = i + o.caretX - s / 2;
